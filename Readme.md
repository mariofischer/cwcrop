...
minsize: {x: 60, y: 60}				- the minimal size of the rectangle (user can't make it smaller)
maxsize: {x: 200, y: 200} 			- the maximal size of the rectangle (user can't make it bigger)
